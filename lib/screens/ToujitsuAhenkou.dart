...
class ToujitsuAHenkouScreen extends StatefulWidget {
  const ToujitsuAHenkouScreen({super.key});

  @override
  State<ToujitsuAHenkouScreen> createState() => _ToujitsuAHenkouScreenState();
}

class _ToujitsuAHenkouScreenState extends State<ToujitsuAHenkouScreen> {
  // 初期化データ
