...
class ToujitsuHenkouScreen extends StatefulWidget {
  const ToujitsuHenkouScreen({super.key});

  @override
  State<ToujitsuHenkouScreen> createState() => _ToujitsuHenkouScreenState();
}

class _ToujitsuHenkouScreenState extends State<ToujitsuHenkouScreen> {
  // 初期化データ
  ...
  void _initializeData() {
    try {
      ...
      int maxkoutaikanouninzuu = myTeamSenshu.length - kukansuu;
      if (kukansuu <= 6) {
        koutaikanouninzuu = 2;
      } else if (kukansuu <= 8) {
        koutaikanouninzuu = 3;
      ...
      if (koutaikanouninzuu > maxkoutaikanouninzuu) {
                        ...
                        showGeneralDialog(
                          ...
                          pageBuilder:
                              (context, animation, secondaryAnimation) {
                                ...
                                return AllToujitsuHenkouScreen(); // const を追加
                              },
                          transitionBuilder:
