...
part 'univ_gakuren_data.g.dart'; // このファイル名に合わせてください

@HiveType(typeId: 11) // ユニークなtypeIdを指定
class UnivGakurenData extends HiveObject {
  @HiveField(0)
  ...
  factory UnivGakurenData.initial({required int id}) {
  ...
  // UnivGakurenData クラス内 (修正後の toJson() のみ)
  ...
  factory UnivGakurenData.fromJson(Map<String, dynamic> json) {
    return UnivGakurenData(
      id: json['id'] as int,
      r: json['r'] as int,
