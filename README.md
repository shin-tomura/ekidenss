...
私自身のプログラミングのはじめの一歩は、昔「BASICで書かれたゲームのコードを改造して遊んだこと」でした。このアプリのコードは決して綺麗に整理されたものではありませんが、昔の私のように「パラメーターを少し書き換えて自分だけの最強設定にして遊ぶ」といった、プログラミングの楽しさに触れるきっかけになれば嬉しいです。
