...
私自身のプログラミングのはじめの一歩は、昔「BASICで書かれたゲーム(初代の信長の野望のX1版)のコードを改造して遊んだこと」でした。このアプリのコードは決して綺麗に整理されたものではありませんが、昔の私のように「パラメーターを少し書き換えて自分だけの設定にして遊ぶ」といった、プログラミングの楽しさに触れるきっかけになれば嬉しいです。

初心者の方はまず「Flutter 環境構築」などで調べてみてください。動かせる環境さえ作れれば、あとは数値をいじるだけでも立派なプログラミングの第一歩です。ぜひ自由に改変して遊んでみてください！
