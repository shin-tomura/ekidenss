...
part of 'senshu_data.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SenshuDataAdapter extends TypeAdapter<SenshuData> {
  @override
  final int typeId = 0;

  @override
  SenshuData read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, SenshuData obj) {
    writer
      ..writeByte(60)
      ..writeByte(0)
      ..write(obj.id)
