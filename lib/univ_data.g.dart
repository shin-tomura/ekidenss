...
part of 'univ_data.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class UnivDataAdapter extends TypeAdapter<UnivData> {
  @override
  final int typeId = 1;

  @override
  UnivData read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, UnivData obj) {
    writer
      ..writeByte(37)
      ..writeByte(0)
      ..write(obj.id)
