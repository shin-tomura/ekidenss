...
part of 'senshu_r_data.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class SenshuRDataAdapter extends TypeAdapter<Senshu_R_Data> {
  @override
  final int typeId = 6;

  @override
  Senshu_R_Data read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, Senshu_R_Data obj) {
    writer
      ..writeByte(60)
      ..writeByte(0)
      ..write(obj.id)
